...
def license():
    ...
    licenseWindow = Tk()
    licenseWindow.resizable(width=False, height=False)
    licenseWindow.iconbitmap('icons/license.ico')
    licenseWindow.title('© 2020 Evan Sonin')
    labelLicense = Label(licenseWindow, text=licenseText).pack()
